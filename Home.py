...
root.title("Wellcome To 3D Hand Geometry Using Machine Learning")
w = tk.Label(root, text="3D Hand Geometry Using Machine Learning",background="gray51",foreground="orange",width=40,height=2,font=(('Forte', 35, 'italic' )))
w.place(x=0,y=-8)
...
bg.resize((100,200),Image.ANTIALIAS)
print(w,h)
...
Disease3=tk.Button(root,text="Capture Hand Geometry",command=right,width=20,bd=8,height=2,background="gray35",foreground="orange",font=("Times new roman",14,"bold"))
Disease3.place(x=1200,y=14)

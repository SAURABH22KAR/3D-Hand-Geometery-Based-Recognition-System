...
class login_system:
    ...
    # Create Widgets
        ...
        self.bg1_icon=ImageTk.PhotoImage(file=r"h1.jpg")
        ...
        title=Label(self.root, text="LOG IN", font=("Times new roman", 40, "bold"), bg="gray51",fg="orange",bd=5,relief=RAISED)
        ...
        btn_log=Button(Login_frame,text="Login",bd=8, command=self.login,width=15,font=("Times new roman", 14, "bold"),bg="gray51",fg="orange").grid(row=3,column=1,pady=10)

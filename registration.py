...
window.title("NEW USER REGISTRATION")
...
lbl = tk.Label(window, text="New User Registration", font=('times', 35,' bold '), height=2, width=50,bg="gray51",fg="orange")
lbl.place(x=0, y=0)
...
btn = tk.Button(frame, text="Register",bd=8, bg="gray51",font=("Times new roman",20,"bold"),fg="orange", width=9, height=1, command=insert)
